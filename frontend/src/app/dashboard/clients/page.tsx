  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
        <h1 style={{ fontSize: '2rem', fontWeight: 800, color: '#0f172a' }}>Clients</h1>
      ...
      <div style={{ background: 'white', borderRadius: '12px', border: '1px solid #e2e8f0', padding: '60px 20px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>No Clients Yet</h2>
        <p style={{ color: '#64748b', maxWidth: '400px', margin: '0 auto' }}>Client management features are coming soon. Your unique clients from invoices will appear here.</p>
      </div>
    </div>
  );
}

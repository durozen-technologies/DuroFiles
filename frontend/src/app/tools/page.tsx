...
export default function Tools() {
  ...
  const ToolCard = ({ icon, title, desc, btn }: any) => (
    <div style={{ background: 'white', padding: '24px', borderRadius: '12px', border: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', height: '100%', cursor: 'pointer', transition: 'all 0.2s', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }} className="tool-card" onClick={() => router.push('/templates')}>
